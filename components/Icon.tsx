...
export const IconVolleyball: React.FC<IconProps> = ({ className }) => (
  <svg
  ...
  >
    ...
    <path d="M12 12a10 10 0 0 0-3.32-7.4" />
    <path d="M12 12a10 10 0 0 1-3.32 7.4" />
    <path d="M12 22a10 10 0 0 0 3.32-17.4" />
    <path d="M2.68 15.32A10 10 0 0 1 12 2" />
  </svg>
);
...
export const IconTrophy: React.FC<IconProps> = ({ className }) => (
  ...
  >
    ...
    <path d="M4 22h16" />
    <path d="M10 14.66V17c0 .55-.47.98-.97 1.21A3.48 3.48 0 0 1 9 19c-1.66 0-3-1.34-3-3" />
    <path d="M14 14.66V17c0 .55.47.98.97 1.21A3.48 3.48 0 0 0 15 19c1.66 0 3-1.34 3-3" />
    <path d="M9 4h6" />
    <path d="M12 4v10" />
  </svg>
);
...
export const IconMedal: React.FC<IconProps> = ({ className }) => (
    <svg 
        ...
        className={className}
    >
        <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 16.5a6.5 6.5 0 1 1 0-13 6.5 6.5 0 0 1 0 13z"/>
        <path d="M12 10.5a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
        <path d="M10 4.152l-1.423-1.424-.707.707L9.293 4.86a8.01 8.01 0 0 1 5.414 0l1.423-1.424-.707-.707L14 4.152A7.95 7.95 0 0 1 12 4a7.95 7.95 0 0 1-2-0.152z"/>
    </svg>
);
...
export const IconHelp: React.FC<IconProps> = ({ className }) => (
...
export const IconUserCircle: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M6.13 18.39A8 8 0 0 1 17.87 18.39" />
  </svg>
);
...
export const IconSwitch: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const IconUserSwap: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M8 20v-5h8v5"/>
    <path d="M6 18H4a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h2"/>
    <path d="M18 18h2a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/>
...
export const IconLightbulb: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    ...
    <path d="M12 2a6 6 0 0 1 4.24 10.24L15 14h-2l-1.24-1.76A6 6 0 0 1 12 2z"/>
    <path d="M12 14v4"/>
    <path d="M8.5 16.5h7"/>
  </svg>
);
...
export const IconClipboardCheck: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" />
    <rect x="8" y="2" width="8" height="4" rx="1" ry="1" />
...
export const IconShieldExclamation: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
    <path d="M12 8v4" />
    <path d="M12 16h.01" />
...
export const IconUsersGroup: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3zm5-9a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"/>
        <path d="M17.94 8.12A4.47 4.47 0 0 0 14 6m-2.6 1.7A4.5 4.5 0 0 0 15.06 14"/>
        <path d="M21 14h-1a5 5 0 0 0-4-4"/>
    </svg>
);
